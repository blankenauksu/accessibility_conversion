...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage{amsfonts}
\usepackage{SESlideJimsLandscape}
\usepackage{amsmath}
\usepackage{graphicx}
...
%TCIDATA{Created=Thursday, August 11, 2016 17:22:02}
%TCIDATA{LastRevised=Tuesday, September 16, 2025 21:04:41}
%TCIDATA{<META NAME="GraphicsSave" CONTENT="32">}
%TCIDATA{<META NAME="DocumentShell" CONTENT="Style Editor\Slides - Jim's Landscape">}
%TCIDATA{Language=American English}
%TCIDATA{CSTFile=SESlideJimsLandscape.cst}
%TCIDATA{ComputeDefs=
%$\gamma _{1}=.5$
%$\gamma _{3}=1.5$
%1$k_{o}=1$
...
\item strictly quasiconcave\footnote{\textit{A} function $f$ a quasiconcave
...
\item homogeneous of degree 1\footnote{%
...
lim_{n\rightarrow \infty }\,f_{2}(k,n)=0.$\footnote{%
...
\textit{Consumer's Problem: }Each agent solves%
\begin{equation*}
...
Use this to simplify the problem to the following Lagrangian 
\begin{equation*}
...
The \textit{Firms' Problem: }Each firm chooses inputs of labor and capital
...
\footnote{\textit{Euler's law:} Suppose$f\left( \mathbf{x}\right) $ is
...
\noindent \textit{Definition:}\ A competitive equilibrium in this economy is
...
\textit{An example: \ }Assign particular functional forms. Preferences are 
\begin{equation*}
u\left( c,\ell \right) =\frac{c^{1-\gamma }-1}{1-\gamma }+\frac{\ell
^{1-\gamma }-1}{1-\gamma }
\end{equation*}%
where $\gamma >0$ measures the degree of curvature.\FRAME{dtbpFUX}{4.4996in}{%
3in}{0pt}{\Qcb{$\protect\gamma =.5$ lighter solid line;$\ \protect\gamma =1$
dashed line; $\protect\gamma =1.5$ darker solid line. }}{}{Plot}{\special%
...
"MuPAD";xmin "0";xmax "5";ymin "-5";ymax "5";xviewmin "-0.0005";xviewmax
"5.0005";yviewmin "-5.001";yviewmax "5.001";plottype 12;labeloverrides
3;x-label "consumption";y-label "utility";axesFont "Times New
Roman,12,0000000000,useDefault,normal";num-x-gridlines 24;num-y-gridlines
24;plotstyle "patch";axesstyle "normal";axestips FALSE;xis \TEXUX{c};yis
\TEXUX{u};var1name \TEXUX{$c$};var2name \TEXUX{$u$};function
\TEXUX{$u=\frac{c^{1-\gamma _{1}}-1}{1-\gamma _{1}}$};linecolor
"black";linestyle 1;pointstyle "point";linethickness 1;lineAttributes
"Solid";var1range "0,5";var2range "-5,5";num-x-gridlines 54;num-y-gridlines
49;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";rangeset"XY";function \TEXUX{$u=\ln c$};linecolor "black";linestyle
2;pointstyle "point";linethickness 1;lineAttributes "Dash";var1range
"0,5";var2range "-5,5";num-x-gridlines 24;num-y-gridlines 24;curveColor
"[flat::RGB:0000000000]";curveStyle "Line";rangeset"XY";function
\TEXUX{$u=\frac{c^{1-\gamma _{3}}-1}{1-\gamma _{3}}$};linecolor
"black";linestyle 1;pointstyle "point";linethickness 3;lineAttributes
"Solid";var1range "0,5";var2range "-5,5";num-x-gridlines 24;num-y-gridlines
24;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";rangeset"XY";VCamFile 'T0OJJ204.xvz';valid_file "T";tempfilename
'T0OJJ201.wmf';tempfile-properties "XPR";}}

This is a \textquotedblleft constant relative risk
aversion\textquotedblright\ (CRRA) utility function. At $\gamma =1$ we
define $u\left( c,\ell \right) =\ln c+\ln \ell .$\footnote{%
...
text \textit{Fundamental Methods of Mathematical Economics}.}\pagebreak
...
\end{equation*}%
This is one equation and one unknown. \pagebreak
...
\FRAME{dtbpFUX}{4.4996in}{3in}{0pt}{\Qcb{$\protect\gamma =.5$ lighter solid
line;$\ \protect\gamma =1$ dashed line; $\protect\gamma =1.5$ darker solid
line. }}{}{Plot}{\special{language "Scientific Word";type "MAPLEPLOT";width
4.4996in;height 3in;depth 0pt;display "FRAME";plot_snapshots
TRUE;mustRecompute FALSE;lastEngine "MuPAD";xmin "0";xmax "10";ymin "0";ymax
"1";xviewmin "-0.001";xviewmax "10.001";yviewmin "-0.0001";yviewmax
"1.0001";plottype 12;labeloverrides 3;x-label "z";y-label "leisure";axesFont
"Times New Roman,12,0000000000,useDefault,normal";num-x-gridlines
24;num-y-gridlines 24;plotstyle "patch";axesstyle "normal";axestips
FALSE;xis \TEXUX{z};yis \TEXUX{v8467};var1name \TEXUX{$z$};var2name
\TEXUX{$\ell $};function \TEXUX{$\left[ zk_{o}^{\alpha }\left( 1-\ell
\right) ^{1-\alpha }\right] ^{-\gamma _{1}}\left( 1-\alpha \right)
zk_{o}^{\alpha }\left( 1-\ell \right) ^{-\alpha }=\ell ^{-\gamma
_{1}}$};linecolor "black";linestyle 1;pointstyle "point";linethickness
1;lineAttributes "Solid";var1range "0,10";var2range "0,1";num-x-gridlines
24;num-y-gridlines 24;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";rangeset"XY";function \TEXUX{$\left[ zk_{o}^{\alpha }\left( 1-\ell
\right) ^{1-\alpha }\right] ^{-\gamma _{2}}\left( 1-\alpha \right)
zk_{o}^{\alpha }\left( 1-\ell \right) ^{-\alpha }=\ell ^{-\gamma
_{2}}$};linecolor "black";linestyle 2;pointstyle "point";linethickness
1;lineAttributes "Dash";var1range "0,10";var2range "0,1";num-x-gridlines
24;num-y-gridlines 24;curveColor "[flat::RGB:0000000000]";curveStyle
"Line";function \TEXUX{$\left[ zk_{o}^{\alpha }\left( 1-\ell \right)
^{1-\alpha }\right] ^{-\gamma _{3}}\left( 1-\alpha \right) zk_{o}^{\alpha
}\left( 1-\ell \right) ^{-\alpha }=\ell ^{-\gamma _{3}}$};linecolor
"black";linestyle 1;pointstyle "circle";linethickness 3;lineAttributes
"Solid";var1range "0,10";var2range "0,1";num-x-gridlines 24;num-y-gridlines
24;curveColor "[flat::RGB:0000000000]";curveStyle "Line";VCamFile
'T0OJJ203.xvz';valid_file "T";tempfilename
'T0OJJ200.wmf';tempfile-properties "XPR";}}\pagebreak
...
not have a \textit{corner solution}?\pagebreak
...
\end{equation*}%
\pagebreak Knowing $\ell $ we can find $c$ from $c=zk_{o}^{\alpha }\left(
...
\right. .
\end{equation*}%
In general, be sure to watch for corner solutions.\pagebreak

\textit{Comparative statics. }Both $c$ and $\omega $ are increasing in both $%
...
\section{An economy with a government.}
...
\section{An economy with distortionary taxes.\textit{\ }}
...
\section{An economy with distortionary government expenditures.}
...
\end{equation*}%
so clearly any positive (or negative) subsidy will be inefficient. \pagebreak

\section{An economy with a missing market: valued government expenditures.}
...
g=\frac{1-\ell }{2}.
\end{equation*}%
\pagebreak This into the first gives%
\begin{equation*}
...
\ell &=&\frac{1-\tau }{2}.  \notag
\end{eqnarray}%
$\allowbreak $How should the government choose $g?$ \pagebreak
...
optimal policy. \pagebreak

\section{An economy with an externality.}
...
share of time spent in production. \pagebreak
...
equilibrium do not coincide. Why? \pagebreak
...
\end{equation*}%
Thus $\varsigma =\frac{1-\theta }{2}.$ \ \pagebreak

\section{An economy with imperfect competition.}
...
x_{i}=\left( \alpha ^{2}AL^{1-\alpha }\right) ^{\frac{1}{1-\alpha }}.
\end{equation*}%
Clearly, $x_{i}<x_{i}^{\ast }$. Why?\pagebreak
...
model might give insights into the growth process (R\&D).\pagebreak

\section{An economy with simple dynamics.}
...
substitution. \pagebreak

\section{An economy with savings.}
...
\section{An\ economy with storage.}
...
r_{b}=r_{k}=r.$\pagebreak

\section{A storage economy with diminishing returns.}
...
make this hold. \pagebreak
\end{itemize}

\section{A production economy with diminishing returns.}
...
\section{An economy with three periods.}
...
\section{An economy with heterogeneous agents.}
...
\section{An economy with agents who differ in preferences.}
...
equilibrium and borrows.\pagebreak
...
second period of life we would need $s_{t,t}$ and $s_{t,t+1}.)$\pagebreak
...
\item $c_{t,t+1}=c_{t+1,t++2}=c_{t+2,t+3}...=c_{0}$\pagebreak
\end{itemize}
